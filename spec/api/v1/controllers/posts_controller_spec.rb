...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, id: my_post.id, topic_id: my_topic.id, post: {title: @new_post.title, body: @new_post.body, user: my_user} }
    ...
    describe "POST create" do
      ...
      before { post :create, topic_id: my_topic.id, post: {title: @new_post.title, body: @new_post.body, user_id: my_user.id} }
